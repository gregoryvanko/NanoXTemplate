class IconModule{
    ...
    static Start(Color = "black"){
        ...
        <defs/>
        <g id="Calque-1">
        <path d="M336.228 786.914C336.228 786.914 293.451 472.473 584.46 436.771C800.875 410.216 967.688 610.265 967.688 610.265C967.688 610.265 847.265 875.59 609.572 905.164C487.946 920.28 383.763 856.797 383.763 856.797" fill="none" opacity="1" stroke="#000000" stroke-linecap="round" stroke-linejoin="round" stroke-width="15.9734"/>
        <path d="M245.314 938.187C245.314 938.187 319.788 764.875 500.231 668.664C626.213 601.481 783.09 622.975 783.09 622.975M242.845 619.684C156.87 562.171 124.591 470.748 124.591 374.038C124.591 199.5 266.292 46.6375 266.292 46.6375C266.292 46.6375 364.372 162.799 382.097 284.249C402.672 425.264 314.288 525.22 299.754 537.545M251.778 254.335C160.503 481.416 277.954 626.539 258.583 759.337" fill="none" opacity="1" stroke="#000000" stroke-linecap="round" stroke-linejoin="round" stroke-width="15.9734"/>
        </g>
        </svg>`
    }
}